...
public class DepartmentRestController {
    ...
    public ResponseEntity<DepartmentVM> getDepartmentById(@PathVariable("id") Long id) {
        DepartmentVM departmentVM = departmentService.findById(id);
        if (departmentVM != null) {
            return new ResponseEntity<DepartmentVM>(departmentVM, HttpStatus.OK);
        } else {
    ...
    public ResponseEntity<List<DepartmentVM>> getAllDepartment() {
        ...
        return new ResponseEntity<List<DepartmentVM>>(list, HttpStatus.OK);
    }
