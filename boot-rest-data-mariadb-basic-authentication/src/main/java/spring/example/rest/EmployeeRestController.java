...
public class EmployeeRestController {
    ...
    public ResponseEntity<EmployeeVM> getEmployeeById(@PathVariable("id") Long id) {
        EmployeeVM employeeVM = employeeService.findById(id);
        if (employeeVM != null) {
            return new ResponseEntity<EmployeeVM>(employeeVM, HttpStatus.OK);
        } else {
    ...
    public ResponseEntity<List<EmployeeVM>> getAllEmployee() {
        ...
        return new ResponseEntity<List<EmployeeVM>>(list, HttpStatus.OK);
    }
